...
#    "sliding_window": sliding_window.run,
    "spatio_temporal_criteria": spatio_temporal_criteria.run,
...
def run(data_paths, interaction_bool, trip_id, trajectory_dir=".\\results\\", create_distance_plot=False):
    if not os.path.exists(trajectory_dir):
        os.mkdir(trajectory_dir)

    results = {}
    trajectories = extract_trajectories(data_paths)
